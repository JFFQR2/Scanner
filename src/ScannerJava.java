...
public class ScannerJava extends Thread {
    ...
    JTextArea area = new JTextArea();
     ...
     void copyWithOutSubdirectories(){
        ...
        if (!currentDirectory.isDirectory()){
            System.out.println("This is not directory or directory exists");
            System.exit(0);
        ...
        for (File file : files) {
            if (file.isDirectory()){
                area.append("Exclude "+ file.getName()+"\n\r");
     ...
     void scanDirectory(File inDirectory, File outDirectory) {
         area.append("Scanning directory -" + inDirectory+"\n\r");
     ...
     void copy(File file, File outputDirectory) {
        try (InputStream input = new FileInputStream(file);
            ...
            area.append("Copying " + file + " to directory " + outputDirectory+"\n\r");
     ...
     void autoDelete(File file)
    {
        ...
        else
        {
            ...
            area.append("deleted " + file.getName()+"\n\r");
        }
    }
    @Override
    public void run() {
